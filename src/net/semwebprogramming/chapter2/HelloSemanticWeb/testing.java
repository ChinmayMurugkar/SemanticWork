...
String SWList[] = 
{
       ...
       "n","name","namely","nd","near","nearly","necessary","need","needs","neither","never","nevertheless","next","nine","no","nobody","non","none","noone","nor","normally","not","nothing","novel","now","nowhere","new",
...
int pos=0;           //position of stop word in the main text string
	...
	String arr[]=st.split(" ");
	System.out.println("*********************From testing 1************");
